...
#define QUANTUM_SCRIPT_EXTENSION_BASE16_LICENSE_HPP
...
namespace Quantum {
	namespace Script {
		namespace Extension {
			namespace Base16 {
				namespace License {
					QUANTUM_SCRIPT_EXTENSION_BASE16_EXPORT const char *content();
					QUANTUM_SCRIPT_EXTENSION_BASE16_EXPORT const char *shortContent();
				};
			};
		};
	};
